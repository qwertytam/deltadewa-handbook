...
In practice, charm is what causes put deltas to drift toward zero as expiration approaches even without price movement — creating the need for rolling that See [PART VII](../part-7/index.md) discusses.
