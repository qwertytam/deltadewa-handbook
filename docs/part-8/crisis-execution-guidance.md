...
- **Use the crisis playbook** (see [Scenario-Based Re-Risk Playbook](scenario-based-re-risk-playbook.md)) to determine the equity re-entry cadence based on the magnitude of the decline.
